...
function load(data) {
  ...
  g.append("g")
   ...
   g.append("g")
    .attr("class", "legend")
    .attr("transform", "translate(415,273)") 
    .append("text")
...
function loadshgraphnoanno(data) {
