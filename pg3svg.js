...
{
  //alert("inside");
  d3.select("#pg3svgid").selectAll("rect").remove();
  d3.select("#pg3svgid").selectAll("text").remove();
  d3.select("#pg3svgid").selectAll("path").remove();
  d3.select("#pg3svgid").selectAll("g").remove();
